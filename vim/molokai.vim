...
let s:N3 = [ '#f8f8f0' , '#465457' , 232 , 144  ] " statusline
...
let s:V3 = [ '#f8f8f0' , '#465457' , 232 , 208  ]
...
" Inactive
let s:IA = [ '#dadada' , '#3a3a3a' , 253 , 237 , '' ]
